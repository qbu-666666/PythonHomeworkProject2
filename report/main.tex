...
\begin{enumerate}
    ...
    \item 添加了音效和背景音乐功能，并实验性的添加了一些音效
\end{enumerate}
...
\begin{enumerate}
    ...
    \item: 音乐和音效 - 添加了游戏的背景音乐和音效（出于版权考虑，这些代码没有上传到Github，仅保留了功能）
    \item: 在Github上开发 - 地址为 https://github.com/ChaoFan996/Experiment-Report-Template-SZU/tree/main
\end{enumerate}
...
创建了\texttt{config.json}文件来存储游戏设置，包括屏幕尺寸、飞船速度、子弹属性、外星人属性等：
...
\begin{enumerate}
    \item[] \textbf{已知bug}: 需要将一些已知bug做修复
\end{enumerate}
